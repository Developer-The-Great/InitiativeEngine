...
namespace itv::math{
	...
	GLM_FUNC_QUALIFIER genType elasticEaseIn(genType const& a)
	{
		...
		return std::sin(static_cast<genType>(13) * half_pi<genType>() * a) * math::pow(static_cast<genType>(2), static_cast<genType>(10) * (a - one<genType>()));
	}
	...
	GLM_FUNC_QUALIFIER genType elasticEaseOut(genType const& a)
	{
		...
		return std::sin(-static_cast<genType>(13) * half_pi<genType>() * (a + one<genType>())) * math::pow(static_cast<genType>(2), -static_cast<genType>(10) * a) + one<genType>();
	}
	...
	GLM_FUNC_QUALIFIER genType elasticEaseInOut(genType const& a)
	{
		...
		if(a < static_cast<genType>(0.5))
			return static_cast<genType>(0.5) * std::sin(static_cast<genType>(13) * half_pi<genType>() * (static_cast<genType>(2) * a)) * math::pow(static_cast<genType>(2), static_cast<genType>(10) * ((static_cast<genType>(2) * a) - one<genType>()));
		else
			return static_cast<genType>(0.5) * (std::sin(-static_cast<genType>(13) * half_pi<genType>() * ((static_cast<genType>(2) * a - one<genType>()) + one<genType>())) * math::pow(static_cast<genType>(2), -static_cast<genType>(10) * (static_cast<genType>(2) * a - one<genType>())) + static_cast<genType>(2));
	}
